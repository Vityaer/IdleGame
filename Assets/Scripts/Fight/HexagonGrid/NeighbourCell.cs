...
public class NeighbourCell{
	...
	public void FindWay(HexagonCellScript previousCell, HexagonCellScript target, bool onGround = true, int step = 1){cell.FindWay(previousCell, target, onGround, step);}
